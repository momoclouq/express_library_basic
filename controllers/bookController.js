...
exports.index = function(req, res) {
    async.parallel({
        book_count: function(callback){
            Book.countDocuments({}, callback); //pass empty object as match condition to find all document
        },
...
exports.book_delete_post = function(req, res) {
    async.parallel({
        ...
        if(results.books_bookinstances.length > 0){
            ...
            res.render('book_delete', {title: "Delete Book", book: results.book, books_bookinstances: books_bookinstances});
            return;
        }
        else {
            //book has no instances. Delete the book and redirect to the list of all books
